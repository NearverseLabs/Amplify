export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    paginate_campaigns: IDL.Func([PaginationArgs, CampaignFilter], [IDL.Vec(UserCampaign)], []),
    ...
    paginate_winners: IDL.Func([IDL.Nat64, PaginationArgs], [IDL.Vec(Participant)], []),
    participate_in_campaign: IDL.Func([IDL.Nat64], [CommonResult], []),
    register_user: IDL.Func([Users], [CommonResult], []),
    search_campaigns_by_project_name: IDL.Func([IDL.Text], [IDL.Vec(Campaign)], []),
    select_winners: IDL.Func([IDL.Nat64], [CommonResult], []),
    submit_participants: IDL.Func([IDL.Nat64, IDL.Vec(IDL.Principal)], [CommonResult], []),
    ...
    update_min_reward_amount: IDL.Func([Principal, IDL.Nat64, IDL.Text], [CommonResult], []),
    ...
    whitelist_token: IDL.Func([Principal, IDL.Nat64, IDL.Text], [WhiteListedTokenResult], []),
  })
}
