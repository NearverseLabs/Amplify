...
import type { GateCheckFailed, GateCheckFailedReason, Member, Message, MessageContent, ChannelSummary, Metrics, ChannelIdentifier, GroupSubtype, EventWrapper, UpdatedEvent, CanisterNotFound, GroupMembershipUpdates } from "../chat";
import type { DataContent } from "../data";
import type { OptionUpdate } from "../optionUpdate";
import type { ChatPermissions, CommunityPermissions, HasMembershipRole, MemberRole, Permissioned } from "../permission";
import type { ChannelNotFound, ChatNotFound, CommunityFrozen, CommunityPublic, Failure, InternalError, NotAuthorised, Offline, Success, SuccessNoUpdates, UserLapsed, UserLimitReached, UserNotInChannel, UserNotInCommunity, UserSuspended } from "../response";
...
export type CommunitySummary = AccessControlled & HasLevel & HasMembershipRole & Permissioned<CommunityPermissions> & {
    kind: "community";
    name: string;
...
export type AddMembersToChannelResponse = AddMembersToChannelFailed | AddMembersToChannelPartialSuccess | UserNotInChannel | ChannelNotFound | UserLimitReached | NotAuthorised | Success | UserNotInCommunity | UserSuspended | UserLapsed | CommunityFrozen | InternalError | Offline | CommunityPublic;
...
export type DeleteChannelResponse = UserNotInChannel | ChatNotFound | NotAuthorised | Success | UserNotInCommunity | UserSuspended | CommunityFrozen | Offline;
...
export type UpdateCommunityResponse = Failure | Offline | {
    kind: "success";
    rulesVersion: number | undefined;
};
export type ToggleMuteCommunityNotificationsResponse = Failure | Success | Offline;
export type CreateCommunityResponse = Offline | Failure | (Success & {
    id: string;
}) | {
    kind: "name_taken";
};
export type JoinCommunityResponse = Failure | Offline | GateCheckFailed | (Success & {
    community: CommunitySummary;
});
export type CommunitySummaryResponse = Failure | CommunitySummary;
export type CommunitySummaryUpdatesResponse = SuccessNoUpdates | Failure | CommunityCanisterCommunitySummaryUpdates;
...
export type ConvertToCommunityResponse = (Success & {
    id: ChannelIdentifier;
}) | Failure | Offline;
export type ImportGroupResponse = (Success & {
...
export type UpdateUserGroupResponse = Success | {
    kind: "name_taken";
} | Failure | Offline;
export type DeleteUserGroupsResponse = Success | Failure | Offline;
export type SetMemberDisplayNameResponse = "success" | "user_not_in_community" | "user_suspended" | "user_lapsed" | "community_frozen" | "display_name_too_short" | "display_name_too_long" | "display_name_invalid" | "offline";
export type FollowThreadResponse = "success" | "unchanged" | "failed" | "offline";
export type FreezeCommunityResponse = "success" | "community_already_frozen" | "community_not_found" | "not_authorized" | "internal_error" | "offline";
export type UnfreezeCommunityResponse = "success" | "community_not_frozen" | "community_not_found" | "not_authorized" | "internal_error" | "offline";
