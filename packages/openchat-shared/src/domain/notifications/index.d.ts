...
export type Notification = AddedToChannelNotification | ChannelNotification | DirectNotification | GroupNotification | ChannelReaction | DirectReaction | GroupReaction | ChannelMessageTipped | DirectMessageTipped | GroupMessageTipped;
...
export type NotificationStatus = "pending-init" | "unsupported" | "prompt" | "soft-denied" | "hard-denied" | "granted";
