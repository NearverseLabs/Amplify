...
import type { Failure, InternalError, Invalid, Offline, Retrying, Success, TransferFailed, UserSuspended } from "../response";
...
export declare function deletedUser(userId: string): UserSummary;
export declare function mergeUserSummaryWithUpdates(cached: UserSummary | undefined, updates: UserSummaryUpdate, timestamp: bigint): UserSummary | undefined;
export declare function userSummaryFromCurrentUserSummary(chitState: ChitState, currentSummary: CurrentUserSummary): UserSummary;
export declare function updateCreatedUser(created: CreatedUser, summary: CurrentUserSummary): CreatedUser;
...
export declare const ANON_USER_ID = "does_this_need_to_be_a_principal";
export declare const ANON_USERNAME = "guest_user";
export declare const ANON_DISPLAY_NAME = "Guest user";
export declare const ANON_AVATAR_URL = "/assets/anon.svg";
...
export declare function anonymousUser(): CreatedUser;
...
export type CheckUsernameResponse = "success" | "username_taken" | "username_too_short" | "username_too_long" | "username_invalid" | "offline";
export type SetUsernameResponse = "success" | "username_taken" | "user_not_found" | "username_too_short" | "username_too_long" | "username_invalid" | "offline";
export type SetDisplayNameResponse = "success" | "user_not_found" | "display_name_too_short" | "display_name_too_long" | "display_name_invalid" | "offline";
export type InvalidCurrency = {
...
export type SuspendUserResponse = "success" | "user_not_found" | "user_already_suspended" | "internal_error" | "offline";
export type UnsuspendUserResponse = "success" | "user_not_found" | "user_not_suspended" | "internal_error" | "offline";
...
export declare const ModerationFlags: {
    Offensive: ModerationFlag;
    Adult: ModerationFlag;
    UnderReview: ModerationFlag;
};
export type NamedAccount = {
    name: string;
    account: string;
};
export type SaveCryptoAccountResponse = {
    kind: "name_taken";
} | Success | Failure;
export type SubmitProposalResponse = Success | Retrying | UserSuspended | GovernanceCanisterNotSupported | InsufficientPayment | TransferFailed | InternalError | Offline;
...
export type SwapTokensResponse = {
    ...
    kind: "swap_failed";
} | PinNumberFailures | InternalError;
...
export type ApproveTransferResponse = Success | {
    kind: "approve_error";
    error: string;
} | PinNumberFailures | InternalError;
