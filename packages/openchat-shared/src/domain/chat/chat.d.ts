...
import type { ChatPermissionRole, ChatPermissions, HasMembershipRole, MemberRole, OptionalChatPermissions, Permissioned } from "../permission";
import type { ChatListScope, HasLevel } from "../structure";
import type { NotAuthorised, Success, SuccessNoUpdates, UserSuspended, ChatFrozen, Failure, CommunityFrozen, NoChange, UserBlocked, TransferFailed, InternalError, Offline, UserLapsed } from "../response";
import type { CommunityCanisterCommunitySummaryUpdates, CommunityIdentifier, CommunitySummary } from "../community";
import type { ChitEarned } from "../chit";
import type { WalletConfig } from "../crypto";
export type CallerNotInGroup = {
    kind: "caller_not_in_group";
};
export type CanisterNotFound = {
    kind: "canister_not_found";
};
export type MessageContent = FileContent | TextContent | ImageContent | VideoContent | AudioContent | DeletedContent | BlockedContent | PlaceholderContent | PollContent | CryptocurrencyContent | GiphyContent | ProposalContent | PrizeContent | PrizeContentInitial | P2PSwapContent | P2PSwapContentInitial | PrizeWinnerContent | MessageReminderCreatedContent | MessageReminderContent | ReportedMessageContent | UserReferralCard | MemeFighterContent | VideoCallContent;
...
export type CaptionedContent = AttachmentContent | CryptocurrencyContent | GiphyContent | PrizeContent;
export type AttachmentContent = ImageContent | VideoContent | AudioContent | FileContent;
export declare function isAttachmentContent(content: MessageContent): content is AttachmentContent;
export type EditableContent = FileContent | TextContent | ImageContent | VideoContent | AudioContent | GiphyContent;
export declare function isEditableContent(kind: MessageContent["kind"]): kind is EditableContent["kind"];
export declare function isCaptionedContent(content: MessageContent): content is CaptionedContent;
export declare function isTransfer(content: MessageContent): boolean;
export declare function canRetryMessage(content: MessageContent): boolean;
...
} | FailedCryptocurrencyWithdrawal | CompletedCryptocurrencyWithdrawal | Offline | PinNumberFailures;
export type CryptocurrencyWithdrawal = PendingCryptocurrencyWithdrawal | CompletedCryptocurrencyWithdrawal | FailedCryptocurrencyWithdrawal;
...
export declare function messageContextFromString(ctxStr: string): MessageContext;
export declare function messageContextToString(ctx: MessageContext): string;
...
export type ChatEvent = Message | DirectChatCreated | GroupChatCreated | MembersAdded | MemberJoined | AggregateCommonEvents | MembersRemoved | MemberLeft | GroupNameChanged | AvatarChanged | GroupDescChanged | GroupRulesChanged | UsersBlocked | UsersUnblocked | RoleChanged | MessagePinned | MessageUnpinned | PermissionsChanged | GroupVisibilityChanged | GroupInviteCodeChanged | ChatFrozenEvent | GateUpdatedEvent | ChatUnfrozenEvent | EventsTimeToLiveUpdated | UsersInvitedEvent | MembersAddedToDefaultChannel | EmptyEvent | ExternalUrlUpdated;
...
export type ExpiredEventsRange = {
    kind: "expired_events_range";
    start: number;
    end: number;
};
export type ExpiredMessagesRange = {
    kind: "expired_messages_range";
    start: number;
    end: number;
};
export declare function messageContextsEqual(a: MessageContext | undefined, b: MessageContext | undefined): boolean;
export declare function chatIdentifierUnset(id: ChatIdentifier | undefined): boolean;
export declare function chatScopesEqual(a: ChatListScope, b: ChatListScope): boolean;
export declare function chatIdentifiersEqual(a: ChatIdentifier | undefined, b: ChatIdentifier | undefined): boolean;
...
export type MessageActivity = "mention" | "reaction" | "quote_reply" | "tip" | "crypto" | "poll_vote" | "p2p_swap_accepted";
...
export type ChannelSummary = DataContent & AccessControlled & ChatSummaryCommon & HasLevel & Permissioned<ChatPermissions> & {
    kind: "channel";
    id: ChannelIdentifier;
    subtype: GroupSubtype;
    name: string;
...
export type GroupChatSummary = DataContent & ChatSummaryCommon & AccessControlled & HasLevel & Permissioned<ChatPermissions> & {
    kind: "group_chat";
    id: GroupChatIdentifier;
    name: string;
    description: string;
...
export declare function nullMembership(): ChatMembership;
...
export type GroupCanisterGroupChatSummary = AccessControlled & Permissioned<ChatPermissions> & {
    id: GroupChatIdentifier;
    lastUpdated: bigint;
    name: string;
    description: string;
...
export type CandidateGroupChat = AccessControlled & HasLevel & HasMembershipRole & Permissioned<ChatPermissions> & {
...
export type CreateGroupResponse = CreateGroupSuccess | CreateGroupInternalError | CreateGroupNameTooShort | CreateGroupNameTooLong | CreateGroupNameReserved | CreateGroupDescriptionTooLong | GroupNameTaken | AvatarTooBig | MaxGroupsCreated | CreateGroupThrottled | GroupRulesTooShort | GroupRulesTooLong | UnauthorizedToCreatePublicGroup | NotAuthorised | CommunityFrozen | UserSuspended | UserLapsed | {
...
export type SendMessageResponse = SendMessageSuccess | SendMessageRecipientBlocked | SendMessageInvalidRequest | SendMessageTooLong | SendMessageEmpty | TransferCannotBeZero | TransferCannotBeToSelf | SendMessageRecipientNotFound | TransferFailed | TransferLimitExceeded | TransferSuccess | InvalidPoll | SendMessageNotInGroup | CallerNotInGroup | InternalError | CryptoCurrencyNotSupported | NotAuthorised | ThreadMessageNotFound | UserSuspended | UserLapsed | Failure | ChatFrozen | RulesNotAccepted | Offline | CommunityRulesNotAccepted | P2PSwapSetUpFailed | DuplicateMessageId | PinNumberFailures | MessageThrottled;
...
export type GateCheckFailedReason = "not_diamond" | "no_sns_neuron_found" | "dissolve_delay_not_met" | "min_stake_not_met" | "payment_failed" | "insufficient_balance" | "failed_verified_credential_check" | "no_unique_person_proof" | "not_lifetime_diamond" | "locked" | "not_referred_by_member";
...
export type BlockUserResponse = "success" | "group_not_public" | "user_not_in_group" | "caller_not_in_group" | "not_authorized" | "internal_error" | "cannot_block_self" | "cannot_block_user" | "user_suspended" | "user_lapsed" | "chat_frozen" | "offline";
export type UnblockUserResponse = "success" | "group_not_public" | "cannot_unblock_self" | "caller_not_in_group" | "not_authorized" | "user_suspended" | "user_lapsed" | "chat_frozen" | "offline";
export type LeaveGroupResponse = "success" | "owner_cannot_leave" | "failure" | "offline";
export type JoinGroupResponse = (Success & {
    group: MultiUserChat;
}) | SuccessJoinedCommunity | GateCheckFailed | UserBlocked | Failure | Offline;
...
export type UpdatePermissionsResponse = "success" | "not_authorized" | "not_in_group" | "user_suspended" | "user_lapsed" | "chat_frozen" | "offline";
...
export type RegisterProposalVoteResponse = "success" | "already_voted" | "caller_not_in_group" | "user_not_in_channel" | "channel_not_found" | "user_not_in_community" | "community_frozen" | "no_eligible_neurons" | "proposal_message_not_found" | "proposal_not_found" | "proposal_not_accepting_votes" | "chat_frozen" | "user_suspended" | "user_lapsed" | "internal_error" | "offline";
...
export type FreezeGroupResponse = EventWrapper<ChatFrozenEvent> | "chat_already_frozen" | "chat_not_found" | "not_authorized" | "internal_error" | "offline";
export type UnfreezeGroupResponse = EventWrapper<ChatUnfrozenEvent> | "chat_not_frozen" | "chat_not_found" | "not_authorized" | "internal_error" | "offline";
export type DeleteFrozenGroupResponse = "success" | "chat_not_frozen" | "chat_not_frozen_long_enough" | "chat_not_found" | "not_authorized" | "internal_error" | "offline";
export type AddHotGroupExclusionResponse = "success" | "chat_already_excluded" | "chat_not_found" | "not_authorized" | "internal_error" | "offline";
export type RemoveHotGroupExclusionResponse = "success" | "chat_not_excluded" | "chat_not_found" | "not_authorized" | "internal_error" | "offline";
export type SetGroupUpgradeConcurrencyResponse = "success" | "not_authorized" | "internal_error" | "offline";
export type SetCommunityModerationFlagsResponse = "success" | "community_not_found" | "not_authorized" | "invalid_flags" | "internal_error" | "offline";
...
export type PublicGroupSummaryResponse = (Success & {
    group: GroupChatSummary;
}) | Failure | GroupMoved;
export type GroupMoved = {
    kind: "group_moved";
    location: ChannelIdentifier;
};
...
export type SetPinNumberResponse = Success | PinNumberFailures | {
    kind: "too_short";
    minLength: number;
} | {
    kind: "too_long";
