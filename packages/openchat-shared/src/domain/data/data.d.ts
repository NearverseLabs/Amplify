...
export type UploadChunkResponse = "success" | "file_already_exists" | "file_too_big" | "file_expired" | "chunk_already_exists" | "chunk_index_too_high" | "chunk_size_mismatch" | "allowance_exceeded" | "user_not_found" | "hash_mismatch" | "invalid_file_id" | "full";
...
export type FileInfoResponse = FileInfoSuccess | {
    kind: "file_not_found";
};
...
export type AllocatedBucketResponse = AllocatedBucketSuccess | AllocatedBucketBucketUnavailable | AllowanceExceeded | StorageUserNotFound;
