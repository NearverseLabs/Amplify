...
describe("list utils", () => {
    describe("group by", () => {
        ...
        test("empty list", () => {
            const grouped = (0, list_1.groupWhile)((a, b) => a === b, []);
    ...
    describe("flatMap", () => {
        test("it works", () => {
            ...
            const flat = (0, list_1.flatMap)(xs, (x) => x.a);
    ...
    test("distinctBy", () => {
        ...
        const distinct = (0, list_1.distinctBy)(things, (t) => t.a);
    ...
    test("chunk", () => {
        ...
        expect((0, list_1.chunk)(array, 2)).toEqual([[1, 2], [3, 4], [5, 6], [7, 8], [9]]);
        expect((0, list_1.chunk)(array, 3)).toEqual([
            [1, 2, 3],
            [4, 5, 6],
            [7, 8, 9],
        ]);
