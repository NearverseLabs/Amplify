...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        'add_bucket_canister': IDL.Func([AddBucketCanisterArgs], [AddBucketCanisterResponse], []),
        'add_or_update_users': IDL.Func([AddOrUpdateUsersArgs], [AddOrUpdateUsersResponse], []),
        ...
        'set_bucket_full': IDL.Func([SetBucketFullArgs], [SetBucketFullResponse], []),
