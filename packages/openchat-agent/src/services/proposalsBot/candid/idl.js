...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        'lookup_proposal_message': IDL.Func([LookupProposalMessageArgs], [LookupProposalMessageResponse], ['query']),
        'stake_neuron_for_submitting_proposals': IDL.Func([StakeNeuronForSubmittingProposalsArgs], [StakeNeuronForSubmittingProposalsResponse], []),
