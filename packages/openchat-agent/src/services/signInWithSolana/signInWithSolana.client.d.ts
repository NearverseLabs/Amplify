...
import type { GetDelegationResponse, PrepareDelegationResponse, SiwsPrepareLoginResponse } from "openchat-shared";
export declare class SignInWithSolanaClient extends CandidService {
    private service;
