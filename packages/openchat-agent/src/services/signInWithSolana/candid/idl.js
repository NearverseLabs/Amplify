...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'siws_get_delegation': IDL.Func([Address, SessionKey, Timestamp], [GetDelegationResponse], ['query']),
        'siws_login': IDL.Func([SiwsSignature, Address, SessionKey], [LoginResponse], []),
