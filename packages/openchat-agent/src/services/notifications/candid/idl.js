...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        'push_subscription': IDL.Func([PushSubscriptionArgs], [PushSubscriptionResponse], []),
        'remove_subscription': IDL.Func([RemoveSubscriptionArgs], [RemoveSubscriptionResponse], []),
        'remove_subscriptions_for_user': IDL.Func([RemoveSubscriptionsForUserArgs], [RemoveSubscriptionsForUserResponse], []),
        'subscription_exists': IDL.Func([SubscriptionExistsArgs], [SubscriptionExistsResponse], ['query']),
    });
};
